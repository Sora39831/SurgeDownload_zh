...
func DefaultSettings() *Settings {
	...
	return &Settings{
		...
		Extension: ExtensionSettings{
			...
			ChromeExtensionURL:  "https://github.com/Sora39831/SurgeDownload_zh/releases/latest",
			FirefoxExtensionURL: "https://addons.mozilla.org/en-US/firefox/addon/surge/",
			AuthToken:           "", // Handled specially in TUI
			InstructionsURL:     "https://github.com/Sora39831/SurgeDownload_zh#browser-extension",
		},
	}
}
